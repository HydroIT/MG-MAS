...
* **mg_mas.py** - calcuating the probabilities with markov chains based on the implentation of the first lecture classes.

* **midi_gen_stm.py** - using neural networks instead 
